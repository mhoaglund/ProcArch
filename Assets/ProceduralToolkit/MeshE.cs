...
namespace ProceduralToolkit
{
    ...
    public static class MeshE
    {
        ...
        public static MeshDraft QuadDraft(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector3 vertex3, GameObject go)
        {
            var normal = go.transform.InverseTransformPoint(Vector3.Cross((vertex1 - vertex0), (vertex2 - vertex0)).normalized);
            return new MeshDraft
            {
                vertices = new List<Vector3>(4) { go.transform.InverseTransformPoint(vertex0), go.transform.InverseTransformPoint(vertex1), go.transform.InverseTransformPoint(vertex2), go.transform.InverseTransformPoint(vertex3) },
                normals = new List<Vector3>(4) { normal, normal, normal, normal },
                uv = new List<Vector2>(4) { new Vector2(0, 0), new Vector2(0, 1), new Vector2(1, 1), new Vector2(1, 0) },
                triangles = new List<int>(6) { 0, 1, 2, 0, 2, 3 },
                name = "Quad"
